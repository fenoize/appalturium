...
const navItems = [
  { label: "Mis Trabajos", href: "/portal-tecnico/trabajos", icon: ClipboardList },
  { label: "Perfil", href: "/portal-tecnico/perfil", icon: User },
];

export function PortalTecnicoLayout() {
